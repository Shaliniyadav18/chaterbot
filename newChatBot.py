...
def takeCommand():
    with sr.Microphone() as source:
        ...
        try:
            print("Recognizing...")
            apd_ = r.recognize_google(audio, language="en-in")
            print(f"User said: {apd_}")
...
def check_all_messages(message):
    ...
    def response(bot_response, list_of_words, single_response=True, required_words=[]):
...
while True:
    print("Listening...")
    apd = takeCommand()
    response_from_bot = get_response(apd)
